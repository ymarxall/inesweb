            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <p className="text-gray-600 text-lg"><strong>Alamat:</strong> Jl. Emmy Saelan III No. 70, Makassar, Indonesia</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <textarea
                  ...
                  rows="5"
                ></textarea>
                <button className="w-full bg-green-600 text-white p-4 rounded-full font-semibold hover:bg-green-700 transition duration-300">
                  Kirim Pesan
                </button>
              </div>
            </div>
