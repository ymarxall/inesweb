  ...
  return (
    <section id="contact" className="py-20 bg-white" data-aos="fade-up" data-aos-delay="50">
      <div className="container mx-auto px-6">
        ...
        {/* Status Messages */}
        {submitStatus && (
          <div className={`max-w-4xl mx-auto mb-6 p-4 rounded-lg text-center ${
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.instagram.com/coconutdotorg/" className="bg-green-600 text-white p-3 rounded-full hover:bg-green-700 transition duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16 3a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8a5 5 0 0 1 5-5zm0 2H8a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3m-4 3a4 4 0 1 1 0 8a4 4 0 0 1 0-8m0 2a2 2 0 1 0 0 4a2 2 0 0 0 0-4m4.5-3.5a1 1 0 1 1 0 2a1 1 0 0 1 0-2" stroke="currentColor" stroke-width="0.5"/>
                    </svg>
                  </a>
                  {/* YouTube */}
                  ...
                  {/* LinkedIn */}
                  <a href="#" className="bg-green-600 text-white p-3 rounded-full hover:bg-green-700 transition duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
