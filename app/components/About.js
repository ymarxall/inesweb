  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        {/* Header Section */}
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 mx-4 sm:mx-6 lg:mx-10">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-sm sm:max-w-md lg:max-w-lg mx-auto leading-relaxed">
        ...
        <div className="lg:hidden mb-8 sm:mb-12 mx-4 sm:mx-6 lg:mx-10">
          <div className="relative max-w-[80%] sm:max-w-[70%] mx-auto">
            ...
            <div className="absolute top-2 right-2 bg-white rounded-full px-2 sm:px-3 py-1 shadow-lg transform rotate-12 transition-transform duration-300 hover:scale-110">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 mx-4 sm:mx-6 lg:mx-10">
          ...
          <div className="hidden lg:block w-full lg:w-1/2">
            <div className="relative max-w-[80%] sm:max-w-[70%] lg:max-w-[80%] mx-auto lg:mx-0">
              ...
              <div className="absolute top-4 right-4 bg-white rounded-full px-3 sm:px-4 py-1 sm:py-2 shadow-lg transform rotate-12 transition-transform duration-300 hover:scale-110">
                <div className="flex items-center text-xs sm:text-sm font-semibold text-green-500">
                  <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-green-500 rounded-full mr-2 animate-pulse"></div>
                  Digital First
                </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="space-y-4 sm:space-y-6">
              <div className="group bg-white rounded-xl p-4 sm:p-5 md:p-6 shadow-lg hover:shadow-xl border-2 border-gray-100 hover:border-green-500 transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.01]">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-800 mb-2 group-hover:text-green-500 transition-colors duration-300">
